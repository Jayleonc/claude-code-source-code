...
import { createUserMessage, extractTextContent } from '../messages'
import { getSmallFastModel } from '../model/model'
import type { PromptHook } from '../settings/types'
import { asSystemPrompt } from '../systemPromptType'
import { addArgumentsToPrompt, hookResponseSchema } from './hookHelpers'
