...
import { type AgentColorName, setAgentColor } from '../../tools/AgentTool/agentColorManager';
import { type AgentDefinition, getActiveAgentsFromList, isCustomAgent, isPluginAgent } from '../../tools/AgentTool/loadAgentsDir';
