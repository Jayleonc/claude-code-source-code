...
import { getCompoundCommandPrefixesStatic } from '../../../utils/bash/prefix';
import { createPromptRuleContent, generateGenericDescription, getBashPromptAllowDescriptions, isClassifierPermissionsEnabled } from '../../../utils/permissions/bashClassifier';
