...
const ReviewArtifactTool = feature('REVIEW_ARTIFACT') ? (require('../../tools/ReviewArtifactTool/ReviewArtifactTool') as typeof import('../../tools/ReviewArtifactTool/ReviewArtifactTool')).ReviewArtifactTool : null;
const ReviewArtifactPermissionRequest = feature('REVIEW_ARTIFACT') ? (require('./ReviewArtifactPermissionRequest/ReviewArtifactPermissionRequest') as typeof import('./ReviewArtifactPermissionRequest/ReviewArtifactPermissionRequest')).ReviewArtifactPermissionRequest : null;
const WorkflowTool = feature('WORKFLOW_SCRIPTS') ? (require('../../tools/WorkflowTool/WorkflowTool') as typeof import('../../tools/WorkflowTool/WorkflowTool')).WorkflowTool : null;
const WorkflowPermissionRequest = feature('WORKFLOW_SCRIPTS') ? (require('../../tools/WorkflowTool/WorkflowPermissionRequest') as typeof import('../../tools/WorkflowTool/WorkflowPermissionRequest')).WorkflowPermissionRequest : null;
const MonitorTool = feature('MONITOR_TOOL') ? (require('../../tools/MonitorTool/MonitorTool') as typeof import('../../tools/MonitorTool/MonitorTool')).MonitorTool : null;
const MonitorPermissionRequest = feature('MONITOR_TOOL') ? (require('./MonitorPermissionRequest/MonitorPermissionRequest') as typeof import('./MonitorPermissionRequest/MonitorPermissionRequest')).MonitorPermissionRequest : null;
