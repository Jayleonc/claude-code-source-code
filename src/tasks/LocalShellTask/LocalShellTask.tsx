...
import { OUTPUT_FILE_TAG, STATUS_TAG, SUMMARY_TAG, TASK_ID_TAG, TASK_NOTIFICATION_TAG, TOOL_USE_ID_TAG } from '../../constants/xml';
import { abortSpeculation } from '../../services/PromptSuggestion/speculation';
import type { AppState } from '../../state/AppState';
import type { LocalShellSpawnInput, SetAppState, Task, TaskContext, TaskHandle } from '../../Task';
...
import { evictTaskOutput, getTaskOutputPath } from '../../utils/task/diskOutput';
import { registerTask, updateTaskState } from '../../utils/task/framework';
import { escapeXml } from '../../utils/xml';
import { backgroundAgentTask, isLocalAgentTask } from '../LocalAgentTask/LocalAgentTask';
import { isMainSessionTask } from '../LocalMainSessionTask';
import { type BashTaskKind, isLocalShellTask, type LocalShellTaskState } from './guards';
