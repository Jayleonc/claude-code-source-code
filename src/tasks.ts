...
import { DreamTask } from './tasks/DreamTask/DreamTask'
...
import { RemoteAgentTask } from './tasks/RemoteAgentTask/RemoteAgentTask'

/* eslint-disable @typescript-eslint/no-require-imports */
const LocalWorkflowTask: Task | null = feature('WORKFLOW_SCRIPTS')
  ? require('./tasks/LocalWorkflowTask/LocalWorkflowTask').LocalWorkflowTask
  : null
const MonitorMcpTask: Task | null = feature('MONITOR_TOOL')
  ? require('./tasks/MonitorMcpTask/MonitorMcpTask').MonitorMcpTask
  : null
